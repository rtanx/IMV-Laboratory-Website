...
const PersonCard = ({ person }) => {
  return (
    <div className="flex p-4 rounded-lg">
      <div className="mr-4">
        <Image src={person.photoURL} width={64} height={64} layout="fixed" objectFit="cover" alt="Profile Picture" className="rounded-md" />
      </div>
      <div>
        ...
        <Link href={`/people/${person.user_id}`} className="flex items-center mt-2 text-sm gap-x-1 hover:gap-x-2 ease-out duration-300 text-blue-500">
          Visit profile
