    ...
    <>
      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="mx-auto mb-12 px-4 w-full max-w-4xl">
          <div className="flex">
            <div>
              <Image src={person.photo_url} width={150} height={150} layout="fixed" objectFit="cover" alt="Profile Picture" className="rounded-xl" />
              <div className="flex justify-between mt-2 px-4">
                <a href={person.linkedin} target="_blank">
                  <FaLinkedin size={24} className="text-blue-700" />
                </a>
                <a href={`https://www.instagram.com/${person.instagram}`} target="_blank">
            ...
            <div className="ml-8 space-y-2">
              <div className="flex items-center font-bold mb-4">
                ...
                <span className="ml-2 px-2 py-1 self-center text-lg text-blue-500 rounded-lg bg-blue-100">{person.assistant_code}</span>
              </div>
              {person.bio && (
